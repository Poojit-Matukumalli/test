...
<body>
  ...
  <main>
    <h1>About Us</h1>
    <p>This is a demonstration of a Node.js-based static site generator. It shows how you can use Node.js and npm to build static HTML content.</p>
    <h2>How it works</h2>
    <p>Pages are defined as JavaScript modules that export HTML strings. The build script processes these modules and generates static HTML files in the dist/ directory.</p>
    <p>This approach allows you to use JavaScript logic to generate your static content before deployment.</p>
  </main>
  <footer>
