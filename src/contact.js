...
<body>
  ...
  <main>
    <h1>Contact Us</h1>
    <p>You can reach us at: contact@staticsite.example.com</p>
    <p>Since this is a static site, you can modify the contact information directly in the <code>src/contact.js</code> file and rebuild.</p>
    <p>For dynamic contact forms, you would need to add a backend service or use a third-party service.</p>
  </main>
  <footer>
